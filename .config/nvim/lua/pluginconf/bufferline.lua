...
bufferline.setup {
    ...
    options = {
        ...
        persist_buffer_sort = true, -- true, -- whether or not custom sorted buffers should persist
        move_wraps_at_ends = true, -- false, -- whether or not the move command "wraps" at the first or last position
